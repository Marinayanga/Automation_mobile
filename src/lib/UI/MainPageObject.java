...
public class MainPageObject {
    ...
    public boolean countOfArticles(String locator, String error_message, long timeoutInSeconds) {
    ...
    public void swipeUpToFindElement(String locator, String error_message, int max_swipes) {
        ...
        while (driver.findElements(by).size() == 0) {
            if (already_swiped > max_swipes) {
                waitForElementPresent(locator, "Cannot find the element by swipingUp." + error_message, 0);
                return;
            }
            swipeUpQuick();
            ++already_swiped;
