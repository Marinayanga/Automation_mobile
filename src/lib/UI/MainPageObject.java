...
public class MainPageObject {
    ...
    public boolean assertElementHasText(By by, String value, String error_message, long timeoutInSeconds) {
        WebElement element = waitForElementPresent(by, error_message, timeoutInSeconds);
    ...
    public boolean countOfArticles(By by, String error_message, long timeoutInSeconds) {
        //WebElement element = waitForElementPresent(by, error_message, timeoutInSeconds);
    ...
    public void swipeElementToLeft(By by, String error_message, int max_swipes) {
